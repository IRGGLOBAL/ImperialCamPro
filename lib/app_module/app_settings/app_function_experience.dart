...
class AppFunctionExperience extends StatelessWidget {
  AppFunctionExperience({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: AppText(
          text: MyStrings.appfunctionexperiencefaqs.tr,
  ...
  Widget _buildAllQuestionsList(AppSettingController controller) {
    ...
    for (int i = 0; i < controller.appfunctionexperiencetileItems.length; i++) {
      final categoryQuestions = controller.appfunctionexperiencetileItems[i];
