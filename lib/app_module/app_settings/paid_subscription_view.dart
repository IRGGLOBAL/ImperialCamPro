...
class PaidSubscriptionView extends StatelessWidget {
  PaidSubscriptionView({Key? key}) : super(key: key);
  ...
  Widget _buildMainTiles(AppSettingController controller) {
    return Container(
      ...
      child: Column(
        children: [
          _settingsTile(controller, 0, "${MyStrings.paidsubscriptionque1.tr}"),
          _settingsTile(controller, 1, "${MyStrings.paidsubscriptionque2.tr}"),
        ],
      ),
    );
  }
  ...
  Widget _buildDetailList(AppSettingController controller) {
    final items = controller.paidsubscriptiontileItems[controller.selectedTileIndex.value];
    ...
    return Column(
      children: [
        ...
        if (isExpanded)
          Column(
            children: [
              // New container with full width and 80 height
              Container(
                width: double.infinity,
                height: 80,
                margin: const EdgeInsets.fromLTRB(16, 0, 16, 16),
                decoration: BoxDecoration(
                  color: Colors.grey.shade100, // Customize color as needed
                  borderRadius: BorderRadius.circular(8),
                ...
                child: Center(
                  child: Text(
                    'Custom Content Here', // Replace with your content
                    style: TextStyle(
                      fontSize: 14,
