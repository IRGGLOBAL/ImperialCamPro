...
class PowerPluginCamera extends StatelessWidget {
  const PowerPluginCamera({Key? key}) : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _settingsTile(controller, 2, "${MyStrings.imagedetection.tr}"),
  ...
  Widget _buildDetailList(AppSettingController controller) {
    final items = controller.tileItems[controller.selectedTileIndex.value];
