...
class DoorbellHelpSettingView extends StatelessWidget {
   DoorbellHelpSettingView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: AppText(
          text: MyStrings.doorbellfaqs.tr,
  ...
  Widget _buildAllQuestionsList(AppSettingController controller) {
    ...
    for (int i = 0; i < controller.doorbelltileItems.length; i++) {
      final categoryQuestions = controller.doorbelltileItems[i];
