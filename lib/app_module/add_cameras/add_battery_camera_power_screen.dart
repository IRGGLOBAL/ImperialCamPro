...
class AddBatteryCameraPowerScreen extends StatelessWidget {
   AddBatteryCameraPowerScreen({super.key,this.index1=0,this.index2=0});
  int index1=0;
  int index2=0;
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            /// Bold Title
            AppText(
              text: "${manualEntryController.screensData.toList()[index1][index2]!["screen1"][0]}",
              size: AppDimensions.FONT_SIZE_16,
              fontWeight: FontWeight.w600,
              color: MyColor.primaryColor,
            ...
            /// Sub Text
            AppText(
              text: "${manualEntryController.screensData.toList()[index1][index2]["screen1"][1]}",
