...
import 'hunting_camera_scan_qr_code.dart';
import 'hunting_camera_second_screen.dart';

class HuntingCameraQrCode extends StatelessWidget {
  HuntingCameraQrCode({super.key});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            AppText(
              text: MyStrings.scandeviceqrcode.tr,
              size: AppDimensions.FONT_SIZE_16,
              fontWeight: FontWeight.w600,
              color: MyColor.primaryColor,
            ...
            BulletText(
              items: [
                MyStrings.turnonbluetoothtwo.tr,
                MyStrings.turnonbluetooththree.tr,
              ],
            ...
            AppButton(
              ...
              hasShadow: false,
              onTap: () {
                Get.to(HuntingCameraScanQrCode());
              },
              elevation: 0,
              borderWidth: 0,
              isCenter: true,
