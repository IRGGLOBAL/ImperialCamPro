...
class MyStrings {
  ...
  static const String allsetdonegoodjob = "All set done, good job👍";
  ...
  static const String locationValue = "Imperial Tech’s Home";
  ...
  static const String pleaseentertheotherpartysaccount = "Please enter the other party’s account";
  ...
  static const String googleassistantcontent2 = "Note: In the App, change the name of the device to an easily identifiable name such as Alexa; names are usually in English such as “Camera”";
  ...
  static const String googleassistantcontent7 = "5. Enter your Campro app account and password, select the country where your Campro app account is located, then tap “Submit”";
  ...
  static const String mburairhome = "M.Burair’s Home";
  ...
  static const String cameraans1 =
      ...
      "3. Connect your phone to your Wifi first (it is confirmed that it is 2.4 GHz Wifi, and most camera adding features are due to choosing 5GHz Wifi). To determine the Wifi frequency band, please refer to the question “How to determine 2.4 GHz and % GHz Wifi?”\n\n"
  ...
  static const String cameraans3 =
      ...
      "3. If you are unable to determine, you can enter the router’s systemto find the detailed name.\n\n";
...
///Mobile Detection
  ...
  static const String cameramobileetectionque1 = "Why doesn’t the camera have an alarm record?";
  ...
  static const String cameramobileetectionque4 = "Why can’t camera capture animals or vehicles?";
  static const String cameramobileetectionque5 = "Why can’t my phone receive any alarm message push?";
  ...
  static const String cameramobileetectionans2 =
      ...
      "5. Set up an “alarm plan” nad reasonably divide the time period for camera alarms.\n\n"
      "6. Set up the “alarm interval” to eliminate uninterrupted alarms.\n\n" ;
  ...
  static const String cameraimagedetectionans3 =
      "1. Within the 2-meter space range of the camera’s perspective, there should be no obstructions or walls, otherwise infrared rays will gather here and cause overexposure.\n\n";
  ...
  static const String cameramobilereplaytheaterque11 = "Why does the “message” page only display screenshots of alarms?";
  static const String cameramobilereplaytheaterque12 = "Why is the recording time on the “Message” page only 6 seconds?";
  ...
  static const String cameramobilereplaytheaterque15 = "Can’t find cloud playback video after activating “cloud storage”?";
  ...
  static const String cameramobilereplaytheaterans4 =
      "Select 1 min/2 min/3 min recording duration in the “Custom Mode” of “Motion Detection” and default to 10 min.." ;
  ...
  static const String cameramobilereplaytheaterans11 =
      ...
      "1. Micro SD card: After successful installation, the alarm recording will be automatically saved. The default recording time is 10 seconds, and can be manually set to 20 or 30 seconds. Click on the “Message” page > Click “Local Playback” on the “Preview” page to view the alarm recordings saved on the Micro SD card.\n\n"
      "2. Cloud Storage: After activation, upload alarm recordings to the cloud. The free version provides 6 seconds of recording, while the subscription version provides upto 30 seconds of recording. Click on the alarm screenshot on the “Message” page or click on “Cloud Playback” on the “Preview” page to view the alarm recordings saved in the cloud.";
  ...
  static const String cameramobilereplaytheaterans12 =
      ...
      "3. Cloud Storage: The subscription version provides upto 30 seconds of recording. Click on the alarm screenshot on the “Message” page or click on “Cloud Playback” on the “Preview” page to view the alarm recordings saved in the cloud." ;
  ...
  static const String cameramobilereplaytheaterans14 =
      "Visit the local playback page, select the dat thorugh “Calender”, click “Delete”, and all recordings on that day will be cleared." ;
...
///Hardware Issues
  ...
  static const String camerahardwareissuesque5 = "Can’t the camera turn on?";
  ...
  static const String camerahardwareissuesans1 =
      "On th camera preview page, enter “Settings” and locate the “Work Indicator” switch to turn it off." ;
  ...
  static const String camerahardwareissuesans8 =
      "Please check if the speakers and microphone in the “Sound Settings” are tuned on ; If there are still problems after opening, please contact brand after-sales customer service for assistance." ;
...
/// DoorbellFAQs
  ...
  static const String doorbellque9 = "Why can’t the camera detect moving objects?";
  static const String doorbellque10 = "Why can’t the alarm image only be photographed from behind?";
  static const String doorbellque11 = "Why can’t the mobile phone accept the alarm push message?";
  ...
  static const String doorbellans1 =
      "Find the camera’s power button, press and hold the power button for three seconds, and see if the camera’s work light is on." ;
  static const String doorbellans2 =
      "Find the reset button or reset hole on the camera.\n\n"
      "1. If it is the reset button, press and hold the reset button with your fingers for five seconds, then release it after hearing the “cuckoo” from the camera. The reset is successful."
      "2. If it is the reset hole, find the reset pin in the packing box, insert it into the reset hole, press and hold the reset button for five seconds, then release after pressing a “cuckoo” heard from the camera. The reset is successful." ;
  ...
  static const String doorbellans4 =
      ...
      "6. Provide the router’s nameplate." ;
  static const String doorbellans5 =
      "1. Make sure the mobile phone’s QR  code is 15 to 20 cm from the camera lens when you scan the code. You can try scanning the code from multiple angles.\n\n"
  ...
  static const String doorbellans6 =
      ...
      "Solution:\n\n"
      "1. Make sure the place where the camera is installed can receive a fluid WiFi signal. It is recommended that it be above 75%. You can use the “Installation Guide” in the APP to perform network diagnostics, determine where to install the camera and whether the camera can get a smooth WiFi network.\n\n"
  ...
  static const String doorbellans9 =
      ...
      "2. If you need to recognize animals, you need to turn off “Alert when only people appear”\n\n"
  ...
  static const String doorbellans12 =
      ...
      "3. Avoid exposing the camera lens directly to the sun’s rays to avoid accidentally triggering it.\n\n"
      "4. Adjust the sensitivity of motion detection to narrow the camera’s motion detection area.\n\n"
  ...
  static const String doorbellans17 =
      ...
      "4. Adjust the sensitivity of the alarm to narrow the camera’s motion detection area.\n\n"
      "5. An alarm schedule can be set to properly schedule the camera’s alarm period.\n\n"
      "6. The alarm interval of the camera can be set to avoid uninterrupted alarms.\n\n"
  ...
  static const String doorbellans19 =
      ...
      "Check the steps: If there is enough sun, check that the camera’s charging indicator is on and that the charging status is displayed on the APP.\n\n"
  ...
  static const String doorbellans22 =
      "After inserting the SD card into the SD card slot of the camera, check whether the SD card capacity  is shown in the APP under “Video Management”. If “No SD card” is displayed. It means that the SD card detection failed.\n\n"
      "Suggest:\n\n"
  ...
  static const String doorbellans23 =
      "1. On the camera’s APP preview video page. select “Local Playback” or “Cloud Playback” then “Calendar” and “Alarm Point”, select the date and time of recording / drag the timeline. You can play the video.\n\n"
  ...
  static const String doorbellans24 =
      "On the video playing page, click Record to start recording. Click Record again to stop recording. The video files is automatically saved in the phone’s local album. The video in the Handy Album can be sent to the computer using third-party software and played on a computer player." ;
  ...
  static const String doorbellans27 =
      "If the camera purchased a cloud storage service, you will need to request a refund of the cloud storage fee due to a camera failure. If you need to transfer the cloud storage kit to the new camera, please contact the brand manufacturer’s customer service department directly." ;
...
///Battery Camera FAQs
  ...
  static const String batterycameraans1 =
      "Select “Black and White Night Vision” and turn off “Sound and Alarm”." ;

  static const String batterycameraans2 =
      "When the ambient light is insufficient, the full color image will generate noise. To ensure image quality, please set the “Full Color Mode” to “Intelligent Night Vision” or “Black and White Night Vision”." ;

  static const String batterycameraans3 =
      "Abnormal switching of camera night vision filter:\n\n"
      "1. At night, the app opens “Full Color Mode” and repeatedly switches between “Full Color Night Vision” and “Black and White Night Vision”.\n\n"
  ...
  static const String batterycameraans4 =
      "The camera may not automatically turn on the infrared. Please confirm that the current setting for “Full Color Mode” is “Intelligent Night Vision” or “Black and White Night Vision”" ;
  ...
  static const String batterycameraharswareissueans6 =
      "When previewing the camera, enter “Settings” to open “Image Settings” and switch to “Screen Flapping”." ;

/// Audible & Visual Alarm

  static const String batterycameraaudiblevisualalarmque1 = "Why didn’t the horn sound after turning on the “sound and light alarm”?" ;
  static const String batterycameraaudiblevisualalarmque2 = "How to turn off the alarm horn?" ;

  static const String batterycameraaudiblevisualalarmans1 = "Please confirm that the “sound and light alarm” is set to “sound alarm” or “sound and light alarm”." ;
  static const String batterycameraaudiblevisualalarmans2 = "Turn off the “sound and light alarm” completely or select the “white light alarm” mode, and the camera will no longer sound the alarm horn." ;
...
///Network Connection
  ...
  static const String fourgvameranetworkconnectionque12 = "Why is there always a prompt of “Establishing encryption channel”/”Obtaining Image Data”? What if the local SIM card PIN code is locked?" ;
  ...
  static const String fourgvameranetworkconnectionans3 =
      ...
      "2. Check if the SIM card is brand new. If it has been used, the SIM card may not have traffic. Please contact the brand’s after-sales customer service for assistance.\n\n"
      ...
      "4. APN is not compatible. Please import the APN information of the SIM card into the APP (for specific operation, please refer to “How to obtain the APN information of the SIM card” and “How to import APN information”)\n\n"
      "5. The SIM card has a PUK or PIN code (please refer to “What should I do if the local SIM card PIN code is locked?” for specific operations). \n\n" ;
  ...
  static const String fourgvameranetworkconnectionans9 =
      "Operators only recognize products that have signed cooperation agreements with them, and their staff cannot provide accurate information. Please refer to “How to choose a local SIM card?”" ;

  static const String fourgvameranetworkconnectionans10 =
      "1. Install the SIM card onto the phone and find the three information items “APN”, “MNC”, and “MCC” through the phone system settings. Due to the different system settings of different brands of mobile phones, please determine the specific steps through search engines.\n\n"
      "2. Contact the SIM card operator and obtain information on “APN”, “MNC”, and “MCC” by consulting the operator." ;

  static const String fourgvameranetworkconnectionans11 =
      "1. Install the SIM card onto the phone and find the three information items “APN”, “MNC”, and “MCC” through the phone system settings. Due to the different system settings of different brands of mobile phones, please determine the specific steps through search engines.\n\n"
      "2. Contact the SIM card operator and obtain information on “APN”, “MNC”, and “MCC” by consulting the operator.\n\n"
      "The traffic is about to run out or the expiration date is approaching. The app will continue to pop up reminders, please don’t miss them." ;
...
///Mobile Detection
  ...
  static const String fourgvameramobiledetectionque1 = "Why didn’t the camera alarm or record any footage?" ;
  static const String fourgvameramobiledetectionque2 = "Why didn’t the horn sound after turning on the “sound and light alarm”?" ;
  ...
  static const String fourgvameramobiledetectionans1 =
      ...
      "4. Check if motion detection is turned on.\n\n"
      "5. Set the “detection sensitivity” to high gear in the APP.\n\n"
      "5. Capturing animals/vehicles and other objects requires turning off the “daytime human detection” and “nighttime human detection” settings."
  ;

  static const String fourgvameramobiledetectionans2 =
      "1. Please confirm that the “sound and light alarm” is set to “sound alarm” or “sound and light alarm”.\n\n"
      "2. In addition, the sound and light alarm is only effective at night." ;

  static const String fourgvameramobiledetectionans3 =
      "1. Turn off the “sound and light alarm” completely or select the “white light alarm” mode, and the camera will no longer sound the alarm horn." ;
...
///Traffic Purchase
  ...
  static const String fourgvameratrafficpurchasean3 =
      "If it is a standard SIM card:\n\n"
      "1. APP purchase: Click on the “4G” icon at the bottom right of the preview screen to enter the traffic page, which provides functions such as traffic query, purchase and redemption.\n\n"
  ...
  ///Hardware Issue
  static const String fourgvamerahardwareissueque1 = "How to change the camera’s time zone?" ;
...
///image issues
  ...
  static const String babymonitorimageissuesans1 = "1. Within the 2-meter space range of the camera’s perspective, there should be no obstructions or walls, otherwise infrared rays will gather here and cause overexposure." ;
  ...
  static const String appfunctionexperienceans7 =
      ...
      "B: The indicator lamp will glow blue, indicating that the camera’s network is normal. Check if the cellphone network is normal. If the cellular network is not smooth, the video stream may be transmitted to the cellphone, it is recommended that the cellphone switch Wifi to try." ;
  ...
  static const String appfunctionexperienceans10 =
      ...
      "2. Look for the brand’s after-sales mailbox or other contact information in the camera manual or after-sales service card and contact the brand’s customer service staff directly." ;
...
///Account
  ...
  static const String accountque5 = "Why does the “Login information has expired, please log in again” pop up window often appear?" ;
  ...
  static const String accountque10 = "What is the difference between “view only” and “allow control” when sharing cameras?" ;
  ...
  static const String accountque18 = "Why can’t I receive a verification code when changing my password?" ;
  ...
  static const String accountans8 =
      "On the camera sharing page, scan the QR code of the other party’s account or directly enter the other party’s account to send an invitation. After they accept the invitation, they can access it in the shared camera." ;
  ...
  static const String accountans10 =
      ...
      "Viewable only “The shared person can only view real time images; In addition to real time preview, “Allow control” also has permissions such as camera control and viewing local playback." ;
  ...
  static const String accountans16 =
      "Open settings on the camera preview page to enter “Camera Information” and find “Camera Nickname” for editing." ;
  ...
  static const String accountans19 =
      "1. Click on “Help and Feedback” in the app to find the “Message Work Order”, fill in the problem details and leave an email. We will reply to you within 24 hours.\n\n"
      "2. In the camera manual or after-sales service card, search for the brand’s after-sales email or other contact information, and directly contact the brand’s after-sales customer service." ;
...
///Paid Subscription
  ...
  static const String paidsubscriptionans3 =
      ...
      "3. On the next screen, select the payment you want to cancel. After opening, click the “Cancel” button." ;


  static const String paidsubscriptionans4 =
      "1. First, start the “Play store” application. If you cannot find it on your device, slide up on the main screen to open the application drawer, then scroll until you find the application.\n\n"
      ...
      "5. Select the “Unsubscribe” link at the bottom of the page.\n\n"
      "6. Provide a reason to unsubscribe and then click the “Continue” button.\n\n"
      "7. Confirm by selecting the “Cancel Order” button that you wish to cancel the Play Store subscription for the Android Application." ;
  ...
  static const String paidsubscriptionans5 =
      ...
      "4. On the order details page, select the “Unsubscribe” option and click\n\n"
      ...
      "4. After switching to the editing subscription page, click on “unsubscribe” on the page.\n\n"
